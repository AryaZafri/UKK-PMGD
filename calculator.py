...
btn_ac = Button(kalkulator, text='Clear', width=13, font=('arial', 20), bg='#333333', activebackground='light blue',
fg='orange', bd=0, relief=FLAT, command=bersih_all)
btn_ac.grid(row=1, column=0, padx=1, pady=1, columnspan=3)

btn_bersih = Button(kalkulator, text='←', width=4, font=('arial', 20), bg='orange', activebackground='light blue',
fg='white', bd=0, relief=FLAT, command=bersih)
btn_bersih.grid(row=5, column=2, padx=1, pady=1)

btn_equal = Button(kalkulator, text=' = ', width=4 , font=('arial', 20), bg='orange', activebackground='light blue',
fg='white', bd=0, relief=FLAT, command=layar_answer,)
btn_equal.grid(row=5, column=3, padx=0)

for i in range(9):
    btn = Button(kalkulator, text=numbers[i], width=4, font=('arial', 20), bg='#212121', fg='white', bd=0, relief=FLAT,
    command=partial(angka, numbers[i]))
    btn.grid(row=i//3+2, column=i%3, padx=1, pady=1)

for i in range(4):
    btn = Button(kalkulator, text=operators[i], width=4, font=('arial', 20), bg='orange', activebackground='light blue', fg='white', bd=0, relief=FLAT, command=partial(place_operator, operators[i]))
    btn.grid(row=i+1, column=3, padx=1, pady=1)

btn_dot = Button(kalkulator, text='.', width=4, font=('arial', 20), bg='#212121', activebackground='light blue',
fg='white', bd=0, relief=FLAT, command=partial(angka, '.'))
btn_dot.grid(row=5, column=0, padx=1, pady=1)

btn_zero = Button(kalkulator, text='0', width=4, font=('arial', 20), bg='#212121', activebackground='light blue',
